...
export function Footer() {
    ...
    return (
        <div className={"dark contents"}>
            <footer className={`border-t border-white/10 bg-background backdrop-blur-xl py-12 ${(pathname.includes("admin") || pathname.includes("login")) ? "hidden" : ""}`}>
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex flex-col gap-2">
                        <Link href="/" className="flex items-center gap-2">
                            ...
                            <Image src="/ssa-rp.png" alt="Logo" width={50} height={50} className="rounded-lg" />
